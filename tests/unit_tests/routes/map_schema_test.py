...
from carnage.routes.map.map_schema import route
from tests.unit_tests.conftest import APPLICATION_PREFIX, DummySchemaFields

MapSchemaOutput = namedtuple(
    "MapSchemaOutput",
    (*DummySchemaFields._fields, "name", "description", "map_difficulty_id"),
)
BASE_URL = f"http://test/{APPLICATION_PREFIX}/map_schema"
