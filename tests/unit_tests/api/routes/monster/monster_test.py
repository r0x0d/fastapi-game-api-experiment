...
from carnage.api.routes.monster.monster import route
...
BASE_URL = f"http://test/{APPLICATION_PREFIX}/monster"
        ...
        (
            [
                MonsterOutput(
                    ...
                    critical_attack_threshold=10.0,
                ),
            ]
        ),
    ),
        ...
        (
            {
                ...
                "base_armor_resistance": 10,
                "base_magical_resistance": 10,
                "monster_type_id": str(uuid4()),
                "size_id": str(uuid4()),
                "aligment_id": str(uuid4()),
                "attack_threshold": 10.0,
                "critical_attack_threshold": 10.0,
            }
        ),
